		...
		addClass: function() { //添加类
			switch (this.hash) {
				...
				case "#modules/productstore.html":
					this.navLi.eq(8).addClass("active");
					break;
...
var navUsername = new Vue({
	...
	data: {
		user: {},
		userIfo: {},
		params: $HQ.getUrlParams(location.href)
	},
	created: function() {
		/*$.post("accountinfo.action", {}, function(data) {
			self.userIfo = data;
		});*/
	},
	ready: function() {
	...
	methods: {
		...
		out: function() {
			...
			if (confirm("确定退出登录？")) {
				...
				window.location.href = "../../pages/pc/firstPage.html";
			}
		},
		//返回店铺页面
		...
		changeshop: function(e) {
			window.location.href = "../../pages/pc/creatshop.html";
		}
	}
